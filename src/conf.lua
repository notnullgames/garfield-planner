function love.conf(t)
  t.identity = "garfield"                -- The name of the save directory (string)
  ...
  t.window.title = "Garfield"            -- The window title (string)
...
return {
  dev = true                            -- Development mode. Live-reloads on chnage. Disable for web.
}